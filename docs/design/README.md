...
| [brand/](brand/) | **Brand** | The **Mentor** mark — a Corinthian helm whose face opening is already a T, so one aperture carries helm, owl and letter. SVG assets, palette, type and usage rules. *(Chosen from a nine-direction identity study.)* |
