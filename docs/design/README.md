...
| [document-sharing.md](document-sharing.md) | **Document sharing** | Three capabilities (view / edit / manage) over the grants table that already exists; team principals inside an org; expiring grants; derived documents inherit at creation. *(Proposal.)* |
