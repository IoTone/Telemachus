...
% The PDF gets a real cover page and a sketch on every chapter head; the HTML edition
% (pandoc) gets the sketch under pandoc's own title block instead. build.sh flips
% this switch to \pdfonlyfalse on the copy it hands to pandoc.
\newif\ifpdfonly
\pdfonlytrue

\ifpdfonly
  % every chapter opens with Telemachus in the margin — the head vignette from art/
  \titleformat{\chapter}[display]
    {\normalfont\bfseries}
    {\includegraphics[height=2.4cm]{art/telemachus-head.png}\hfill{\Large\chaptertitlename\ \thechapter}}
    {14pt}{\Huge}
  \titleformat{name=\chapter,numberless}[display]
    {\normalfont\bfseries}
    {\includegraphics[height=2.4cm]{art/telemachus-head.png}}
    {14pt}{\Huge}
...
\ifpdfonly
  \begin{titlepage}
    \centering
    \vspace*{1.2cm}
    {\Huge\bfseries Telemachus for Developers\par}
    \vspace{0.5em}
    {\large A small book about a Racket-first, self-hosted team AI platform\par}
    \vspace{1.4cm}
    \includegraphics[height=0.52\textheight]{art/telemachus-sketch.png}\par
    \vspace{1.2cm}
    {\large IoTone, Inc.\par}
    \vspace{0.3em}
    {\large September 2026 --- version 0.1.0\par}
    \vfill
    {\small\itshape Telemachus, a concept sketch: a young Ithacan with a scroll, Mentor's owl on his shoulder.\par}
  \end{titlepage}
\else
  \maketitle
  \begin{center}
    \includegraphics[width=0.55\textwidth]{art/telemachus-sketch.png}
  \end{center}
\fi
