...
| Integrator demo (`integrator-demo`) | 0.1.0 | `shipment_eta` | — | `GET /eta`, `POST /eta` | — | The worked example for docs/integrators-guide.md: a tool, an authenticated route, a background job kind and a themed screen. |
