...
// argv: [subdir] [title] [subtitle] [footer] — default = the feature tour at catalog/
const SUBDIR   = process.argv[2] || '.';
const TITLE    = process.argv[3] || 'Telemachus — Feature Tour';
const SUBTITLE = process.argv[4] || 'An automated Playwright walk through the running system — bootstrap, streaming chat, agentic tool use, the translation app, notes, teams &amp; RBAC, quotas &amp; the tool registry, federated compute, and full localization.';
const FOOTER   = process.argv[5] || 'Generated by test/e2e/run-tour.mjs — a headless Playwright tour that boots a fresh server, drives the real UI, and captures this catalog.';
const CAT = path.join(HERE, 'catalog', SUBDIR);
...
const SECTION = {
  ...
  '09-tier-b-bundle': ['Tier B', '/beta/bundle/…'],
};
